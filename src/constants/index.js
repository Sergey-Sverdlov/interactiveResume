...
export const experiences = [
    {
        ...
        company_name: "Ecoplatform",
        icon: eco,
        iconBg: "#accbe1",
        date: "Июнь 2024 — по настоящее время",
        points: [
            "Исправил более 15 критических багов, возникающих у пользователей на разных устройствах " +
            "различных операционных системах мобильных устройств.",
            "Добавил международные интеграции партнеров в мобильное приложение, увеличил количество " +
            "активных пользователей на 3%.",
            "Разрабатывал приложения для пользователей со всего мира на IOS и Android (Ecoplatform, Sparklo)",
            "Создал более 5 компонентов для собственного UI, ускорив дальнейшую разработку на 10%.",
            "Проводил ревью, проектирование и тестирование своих и чужих задач. " +
            "Увеличил скорость разработки программ на 3%",
            "Разработал взаимодействие с backend через Apollo GraphQL",
        ],
    },
    {
