    ...
    return (
        <section className="max-container">
            ...
            <div className="mt-5 flex flex-col gap-3 text-slate-500 ">
                <p>
                    Создаю Frontend SPA веб-сайты на React.JS, мобильные приложения на React Native и занимаюсь backend
                    проектированием на Node.JS. В данном разделе указана часть реализованных проектов, большинство из них
