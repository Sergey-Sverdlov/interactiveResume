        ...
        <section className="max-container">
            ...
            <div className="mt-5 flex flex-col gap-3 text-slate-500 ">
                <p>
                    ...
                    <br />Разрабатываю мобильные приложения на React Native для IOS и Android. <br/>
                ...
                <div className="py-16">
                    ...
                    <div className="mt-5 flex flex-col gap-3 text-slate-500 ">
                        <p>
                            ...
                            WEB-3 технологий.
                            Являюсь выпускником университета МГТУ им. Баумана по направлению "Программная инженерия"
                            Более пяти лет являюсь преподавателем программирования для людей со всего мира!
                            Люблю изучать новое, реализовывать идеи согласно ТЗ, объяснять
                            web-программирование и совершенствовать свои знания в нем.
                        </p>
                    </div>
